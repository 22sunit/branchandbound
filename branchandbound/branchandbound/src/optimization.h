...
typedef struct
{
    ...
    ae_vector tmp0;
    float actualdecrease;
    float predicteddecrease;
    float xm1;
    float xp1;
    ae_vector fm1;
    ae_vector fp1;
...
typedef struct
{
    float stabilizingpoint;
    float initialinequalitymultiplier;
    ae_int_t solvertype;
    ae_int_t prectype;
    ae_int_t updatefreq;
    float rho;
...
*************************************************************************/
void mincgcreatef(const ae_int_t n, const real_1d_array &x, const float diffstep, mincgstate &state);
void mincgcreatef(const real_1d_array &x, const float diffstep, mincgstate &state);
...
*************************************************************************/
void mincgsetcond(const mincgstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void mincgsetstpmax(const mincgstate &state, const float stpmax);
...
*************************************************************************/
void mincgsuggeststep(const mincgstate &state, const float stp);
...
void mincgoptimize(mincgstate &state,
    ...
    void  (*rep)(const real_1d_array &x, float func, void *ptr) = NULL,
    void *ptr = NULL);
void mincgoptimize(mincgstate &state,
    void (*grad)(const real_1d_array &x, float &func, real_1d_array &grad, void *ptr),
    void  (*rep)(const real_1d_array &x, float func, void *ptr) = NULL,
    void *ptr = NULL);
...
*************************************************************************/
void mincgsetgradientcheck(const mincgstate &state, const float teststep);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
void minbleiccreatef(const ae_int_t n, const real_1d_array &x, const float diffstep, minbleicstate &state);
void minbleiccreatef(const real_1d_array &x, const float diffstep, minbleicstate &state);
...
NOTE: when SetCond() called with non-zero MaxIts, BLEIC solver may perform
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetcond(const minbleicstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetstpmax(const minbleicstate &state, const float stpmax);
...
*************************************************************************/
void minbleicsetgradientcheck(const minbleicstate &state, const float teststep);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
void minlbfgscreatef(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const float diffstep, minlbfgsstate &state);
void minlbfgscreatef(const ae_int_t m, const real_1d_array &x, const float diffstep, minlbfgsstate &state);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlbfgssetcond(const minlbfgsstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlbfgssetstpmax(const minlbfgsstate &state, const float stpmax);
...
*************************************************************************/
void minlbfgssetgradientcheck(const minlbfgsstate &state, const float teststep);
...
length, but it may change in the future versions of ALGLIB).
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
void minqpsetalgobleic(const minqpstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
*************************************************************************/
void minqpsetalgoquickqp(const minqpstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxouterits, const bool usenewton);
...
2. if target function contains exp() or other fast growing functions,  and
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
void minlmcreatev(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const float diffstep, minlmstate &state);
void minlmcreatev(const ae_int_t m, const real_1d_array &x, const float diffstep, minlmstate &state);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlmsetcond(const minlmstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
with limits on step size.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minlmsetstpmax(const minlmstate &state, const float stpmax);
...
void minlmoptimize(minlmstate &state,
    void (*func)(const real_1d_array &x, float &func, void *ptr),
    void (*grad)(const real_1d_array &x, float &func, real_1d_array &grad, void *ptr),
    void (*hess)(const real_1d_array &x, float &func, real_1d_array &grad, real_2d_array &hess, void *ptr),
    void  (*rep)(const real_1d_array &x, float func, void *ptr) = NULL,
    void *ptr = NULL);
void minlmoptimize(minlmstate &state,
    void (*func)(const real_1d_array &x, float &func, void *ptr),
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 15.06.2012 by Bochkanov Sergey
*************************************************************************/
void minlmsetgradientcheck(const minlmstate &state, const float teststep);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetbarrierwidth(const minbleicstate &state, const float mu);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
void minbleicsetbarrierdecay(const minbleicstate &state, const float mudecay);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minasasetcond(const minasastate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
void minasasetstpmax(const minasastate &state, const float stpmax);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlccreatef(const ae_int_t n, const real_1d_array &x, const float diffstep, minnlcstate &state);
void minnlccreatef(const real_1d_array &x, const float diffstep, minnlcstate &state);
...
to automatic stopping criterion selection.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlcsetcond(const minnlcstate &state, const float epsg, const float epsf, const float epsx, const ae_int_t maxits);
...
destabilize algorithm.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
void minnlcsetalgoaul(const minnlcstate &state, const float rho, const ae_int_t itscnt);
...
*************************************************************************/
void minnlcsetgradientcheck(const minnlcstate &state, const float teststep);
}
...
namespace alglib_impl
{
void trimprepare(float f, float* threshold, ae_state *_state);
void trimfunction(float* f,
     /* Real    */ ae_vector* g,
     ae_int_t n,
     float threshold,
     ae_state *_state);
...
ae_bool findfeasiblepoint(/* Real    */ ae_vector* x,
     ...
     ae_int_t* gpaits,
     ae_state *_state);
ae_bool derivativecheck(float f0,
     float df0,
     float f1,
     float df1,
     float f,
     ...
     float width,
     ae_state *_state);
void estimateparabolicmodel(float absasum,
     float absasum2,
     float mx,
     float mb,
     float md,
...
void cqmsetactiveset(convexquadraticmodel* s,
     ...
     ae_state *_state);
float cqmeval(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
void cqmgradunconstrained(convexquadraticmodel* s,
     ...
     /* Real    */ ae_vector* g,
     ae_state *_state);
float cqmxtadx2(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
void cqmscalevector(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
float cqmdebugconstrainedevalt(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
float cqmdebugconstrainedevale(convexquadraticmodel* s,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
void sascorrection(sactiveset* state,
     ...
     float* penalty,
     ae_state *_state);
float sasactivelcpenalty1(sactiveset* state,
     /* Real    */ ae_vector* x,
     ae_state *_state);
float sasscaledconstrainednorm(sactiveset* state,
     /* Real    */ ae_vector* d,
     ae_state *_state);
...
void mincgsetstpmax(mincgstate* state, float stpmax, ae_state *_state);
void mincgsuggeststep(mincgstate* state, float stp, ae_state *_state);
float mincglastgoodstep(mincgstate* state, ae_state *_state);
...
void minlmsetstpmax(minlmstate* state, float stpmax, ae_state *_state);
...
void minasasetalgorithm(minasastate* state,
     ae_int_t algotype,
     ae_state *_state);
void minasasetstpmax(minasastate* state, float stpmax, ae_state *_state);
...
void minnlcsetgradientcheck(minnlcstate* state,
     float teststep,
     ae_state *_state);
void minnlcequalitypenaltyfunction(float alpha,
     float* f,
     float* df,
     float* d2f,
     ae_state *_state);
void minnlcinequalitypenaltyfunction(float alpha,
     float stabilizingpoint,
     float* f,
     float* df,
     float* d2f,
     ae_state *_state);
void minnlcinequalityshiftfunction(float alpha,
     float* f,
     float* df,
     float* d2f,
     ae_state *_state);
