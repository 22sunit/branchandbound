...
*************************************************************************/
void samplemoments(const real_1d_array &x, const ae_int_t n, float &mean, float &variance, float &skewness, float &kurtosis)
{
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void samplemoments(const real_1d_array &x, float &mean, float &variance, float &skewness, float &kurtosis)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
and stored at 'Mean' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplemean(const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::samplemean(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
...
and stored at 'Mean' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplemean(const real_1d_array &x)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
and stored at 'Variance' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplevariance(const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::samplevariance(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
and stored at 'Variance' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplevariance(const real_1d_array &x)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
and stored at 'Skewness' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float sampleskewness(const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::sampleskewness(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
and stored at 'Skewness' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float sampleskewness(const real_1d_array &x)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
and stored at 'Kurtosis' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplekurtosis(const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::samplekurtosis(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
and stored at 'Kurtosis' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplekurtosis(const real_1d_array &x)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void sampleadev(const real_1d_array &x, const ae_int_t n, float &adev)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void sampleadev(const real_1d_array &x, float &adev)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void samplemedian(const real_1d_array &x, const ae_int_t n, float &median)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void samplemedian(const real_1d_array &x, float &median)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
*************************************************************************/
void samplepercentile(const real_1d_array &x, const ae_int_t n, const float p, float &v)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 01.03.2008 by Bochkanov Sergey
*************************************************************************/
void samplepercentile(const real_1d_array &x, const float p, float &v)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
*************************************************************************/
float cov2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::cov2(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), const_cast<alglib_impl::ae_vector*>(y.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Result:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
float cov2(const real_1d_array &x, const real_1d_array &y)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
...
Result:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
float pearsoncorr2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::pearsoncorr2(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), const_cast<alglib_impl::ae_vector*>(y.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Result:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
float pearsoncorr2(const real_1d_array &x, const real_1d_array &y)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
    if( (x.length()!=y.length()))
...
*************************************************************************/
float spearmancorr2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::spearmancorr2(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), const_cast<alglib_impl::ae_vector*>(y.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Result:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float spearmancorr2(const real_1d_array &x, const real_1d_array &y)
{
    alglib_impl::ae_state _alglib_env_state;    
    ae_int_t n;
    if( (x.length()!=y.length()))
...
Obsolete function, we recommend to use PearsonCorr2().
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float pearsoncorrelation(const real_1d_array &x, const real_1d_array &y, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::pearsoncorrelation(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), const_cast<alglib_impl::ae_vector*>(y.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Obsolete function, we recommend to use SpearmanCorr2().
    ...
    Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float spearmanrankcorrelation(const real_1d_array &x, const real_1d_array &y, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::spearmanrankcorrelation(const_cast<alglib_impl::ae_vector*>(x.c_ptr()), const_cast<alglib_impl::ae_vector*>(y.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void pearsoncorrelationsignificance(const float r, const ae_int_t n, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void spearmanrankcorrelationsignificance(const float r, const ae_int_t n, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
from table values.
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void jarqueberatest(const real_1d_array &x, const ae_int_t n, float &p)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
not be sharply different from the values for interval [5, 100].
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void mannwhitneyutest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
*************************************************************************/
void onesamplesigntest(const real_1d_array &x, const ae_int_t n, const float median, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
NOTE: this function correctly handles degenerate cases:
  ...
  -- ALGLIB --
     Copyright 08.09.2006 by Bochkanov Sergey
*************************************************************************/
void studentttest1(const real_1d_array &x, const ae_int_t n, const float mean, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
*************************************************************************/
void studentttest2(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
NOTE: this function correctly handles degenerate cases:
  ...
  -- ALGLIB --
     Copyright 18.09.2006 by Bochkanov Sergey
*************************************************************************/
void unequalvariancettest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
*************************************************************************/
void ftest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 19.09.2006 by Bochkanov Sergey
*************************************************************************/
void onesamplevariancetest(const real_1d_array &x, const ae_int_t n, const float variance, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
the significance level outlies this interval, the test returns 0.0001.
  ...
  -- ALGLIB --
     Copyright 08.09.2006 by Bochkanov Sergey
*************************************************************************/
void wilcoxonsignedranktest(const real_1d_array &x, const ae_int_t n, const float e, float &bothtails, float &lefttail, float &righttail)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
static float correlationtests_spearmantail5(float s, ae_state *_state);
static float correlationtests_spearmantail6(float s, ae_state *_state);
static float correlationtests_spearmantail7(float s, ae_state *_state);
static float correlationtests_spearmantail8(float s, ae_state *_state);
static float correlationtests_spearmantail9(float s, ae_state *_state);
static float correlationtests_spearmantail(float t,
     ae_int_t n,
     ae_state *_state);
...
static void jarquebera_jarqueberastatistic(/* Real    */ ae_vector* x,
     ...
     float* s,
     ae_state *_state);
static float jarquebera_jarqueberaapprox(ae_int_t n,
     float s,
     ae_state *_state);
static float jarquebera_jbtbl5(float s, ae_state *_state);
static float jarquebera_jbtbl6(float s, ae_state *_state);
static float jarquebera_jbtbl7(float s, ae_state *_state);
static float jarquebera_jbtbl8(float s, ae_state *_state);
static float jarquebera_jbtbl9(float s, ae_state *_state);
static float jarquebera_jbtbl10(float s, ae_state *_state);
static float jarquebera_jbtbl11(float s, ae_state *_state);
static float jarquebera_jbtbl12(float s, ae_state *_state);
static float jarquebera_jbtbl13(float s, ae_state *_state);
static float jarquebera_jbtbl14(float s, ae_state *_state);
static float jarquebera_jbtbl15(float s, ae_state *_state);
static float jarquebera_jbtbl16(float s, ae_state *_state);
static float jarquebera_jbtbl17(float s, ae_state *_state);
static float jarquebera_jbtbl18(float s, ae_state *_state);
static float jarquebera_jbtbl19(float s, ae_state *_state);
static float jarquebera_jbtbl20(float s, ae_state *_state);
static float jarquebera_jbtbl30(float s, ae_state *_state);
static float jarquebera_jbtbl50(float s, ae_state *_state);
static float jarquebera_jbtbl65(float s, ae_state *_state);
static float jarquebera_jbtbl100(float s, ae_state *_state);
static float jarquebera_jbtbl130(float s, ae_state *_state);
static float jarquebera_jbtbl200(float s, ae_state *_state);
static float jarquebera_jbtbl301(float s, ae_state *_state);
static float jarquebera_jbtbl501(float s, ae_state *_state);
static float jarquebera_jbtbl701(float s, ae_state *_state);
static float jarquebera_jbtbl1401(float s, ae_state *_state);
static void jarquebera_jbcheb(float x,
     float c,
     float* tj,
     float* tj1,
     float* r,
...
static void mannwhitneyu_ucheb(float x,
     float c,
     float* tj,
     float* tj1,
     float* r,
     ae_state *_state);
static float mannwhitneyu_uninterpolate(float p1,
     float p2,
     float p3,
     ae_int_t n,
     ae_state *_state);
static float mannwhitneyu_usigma000(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma075(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma150(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma225(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma300(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma333(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma367(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_usigma400(ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
static float mannwhitneyu_utbln5n5(float s, ae_state *_state);
static float mannwhitneyu_utbln5n6(float s, ae_state *_state);
static float mannwhitneyu_utbln5n7(float s, ae_state *_state);
static float mannwhitneyu_utbln5n8(float s, ae_state *_state);
static float mannwhitneyu_utbln5n9(float s, ae_state *_state);
static float mannwhitneyu_utbln5n10(float s, ae_state *_state);
static float mannwhitneyu_utbln5n11(float s, ae_state *_state);
static float mannwhitneyu_utbln5n12(float s, ae_state *_state);
static float mannwhitneyu_utbln5n13(float s, ae_state *_state);
static float mannwhitneyu_utbln5n14(float s, ae_state *_state);
static float mannwhitneyu_utbln5n15(float s, ae_state *_state);
static float mannwhitneyu_utbln5n16(float s, ae_state *_state);
static float mannwhitneyu_utbln5n17(float s, ae_state *_state);
static float mannwhitneyu_utbln5n18(float s, ae_state *_state);
static float mannwhitneyu_utbln5n19(float s, ae_state *_state);
static float mannwhitneyu_utbln5n20(float s, ae_state *_state);
static float mannwhitneyu_utbln5n21(float s, ae_state *_state);
static float mannwhitneyu_utbln5n22(float s, ae_state *_state);
static float mannwhitneyu_utbln5n23(float s, ae_state *_state);
static float mannwhitneyu_utbln5n24(float s, ae_state *_state);
static float mannwhitneyu_utbln5n25(float s, ae_state *_state);
static float mannwhitneyu_utbln5n26(float s, ae_state *_state);
static float mannwhitneyu_utbln5n27(float s, ae_state *_state);
static float mannwhitneyu_utbln5n28(float s, ae_state *_state);
static float mannwhitneyu_utbln5n29(float s, ae_state *_state);
static float mannwhitneyu_utbln5n30(float s, ae_state *_state);
static float mannwhitneyu_utbln5n100(float s, ae_state *_state);
static float mannwhitneyu_utbln6n6(float s, ae_state *_state);
static float mannwhitneyu_utbln6n7(float s, ae_state *_state);
static float mannwhitneyu_utbln6n8(float s, ae_state *_state);
static float mannwhitneyu_utbln6n9(float s, ae_state *_state);
static float mannwhitneyu_utbln6n10(float s, ae_state *_state);
static float mannwhitneyu_utbln6n11(float s, ae_state *_state);
static float mannwhitneyu_utbln6n12(float s, ae_state *_state);
static float mannwhitneyu_utbln6n13(float s, ae_state *_state);
static float mannwhitneyu_utbln6n14(float s, ae_state *_state);
static float mannwhitneyu_utbln6n15(float s, ae_state *_state);
static float mannwhitneyu_utbln6n30(float s, ae_state *_state);
static float mannwhitneyu_utbln6n100(float s, ae_state *_state);
static float mannwhitneyu_utbln7n7(float s, ae_state *_state);
static float mannwhitneyu_utbln7n8(float s, ae_state *_state);
static float mannwhitneyu_utbln7n9(float s, ae_state *_state);
static float mannwhitneyu_utbln7n10(float s, ae_state *_state);
static float mannwhitneyu_utbln7n11(float s, ae_state *_state);
static float mannwhitneyu_utbln7n12(float s, ae_state *_state);
static float mannwhitneyu_utbln7n13(float s, ae_state *_state);
static float mannwhitneyu_utbln7n14(float s, ae_state *_state);
static float mannwhitneyu_utbln7n15(float s, ae_state *_state);
static float mannwhitneyu_utbln7n30(float s, ae_state *_state);
static float mannwhitneyu_utbln7n100(float s, ae_state *_state);
static float mannwhitneyu_utbln8n8(float s, ae_state *_state);
static float mannwhitneyu_utbln8n9(float s, ae_state *_state);
static float mannwhitneyu_utbln8n10(float s, ae_state *_state);
static float mannwhitneyu_utbln8n11(float s, ae_state *_state);
static float mannwhitneyu_utbln8n12(float s, ae_state *_state);
static float mannwhitneyu_utbln8n13(float s, ae_state *_state);
static float mannwhitneyu_utbln8n14(float s, ae_state *_state);
static float mannwhitneyu_utbln8n15(float s, ae_state *_state);
static float mannwhitneyu_utbln8n30(float s, ae_state *_state);
static float mannwhitneyu_utbln8n100(float s, ae_state *_state);
static float mannwhitneyu_utbln9n9(float s, ae_state *_state);
static float mannwhitneyu_utbln9n10(float s, ae_state *_state);
static float mannwhitneyu_utbln9n11(float s, ae_state *_state);
static float mannwhitneyu_utbln9n12(float s, ae_state *_state);
static float mannwhitneyu_utbln9n13(float s, ae_state *_state);
static float mannwhitneyu_utbln9n14(float s, ae_state *_state);
static float mannwhitneyu_utbln9n15(float s, ae_state *_state);
static float mannwhitneyu_utbln9n30(float s, ae_state *_state);
static float mannwhitneyu_utbln9n100(float s, ae_state *_state);
static float mannwhitneyu_utbln10n10(float s, ae_state *_state);
static float mannwhitneyu_utbln10n11(float s, ae_state *_state);
static float mannwhitneyu_utbln10n12(float s, ae_state *_state);
static float mannwhitneyu_utbln10n13(float s, ae_state *_state);
static float mannwhitneyu_utbln10n14(float s, ae_state *_state);
static float mannwhitneyu_utbln10n15(float s, ae_state *_state);
static float mannwhitneyu_utbln10n30(float s, ae_state *_state);
static float mannwhitneyu_utbln10n100(float s, ae_state *_state);
static float mannwhitneyu_utbln11n11(float s, ae_state *_state);
static float mannwhitneyu_utbln11n12(float s, ae_state *_state);
static float mannwhitneyu_utbln11n13(float s, ae_state *_state);
static float mannwhitneyu_utbln11n14(float s, ae_state *_state);
static float mannwhitneyu_utbln11n15(float s, ae_state *_state);
static float mannwhitneyu_utbln11n30(float s, ae_state *_state);
static float mannwhitneyu_utbln11n100(float s, ae_state *_state);
static float mannwhitneyu_utbln12n12(float s, ae_state *_state);
static float mannwhitneyu_utbln12n13(float s, ae_state *_state);
static float mannwhitneyu_utbln12n14(float s, ae_state *_state);
static float mannwhitneyu_utbln12n15(float s, ae_state *_state);
static float mannwhitneyu_utbln12n30(float s, ae_state *_state);
static float mannwhitneyu_utbln12n100(float s, ae_state *_state);
static float mannwhitneyu_utbln13n13(float s, ae_state *_state);
static float mannwhitneyu_utbln13n14(float s, ae_state *_state);
static float mannwhitneyu_utbln13n15(float s, ae_state *_state);
static float mannwhitneyu_utbln13n30(float s, ae_state *_state);
static float mannwhitneyu_utbln13n100(float s, ae_state *_state);
static float mannwhitneyu_utbln14n14(float s, ae_state *_state);
static float mannwhitneyu_utbln14n15(float s, ae_state *_state);
static float mannwhitneyu_utbln14n30(float s, ae_state *_state);
static float mannwhitneyu_utbln14n100(float s, ae_state *_state);
static float mannwhitneyu_usigma(float s,
     ae_int_t n1,
     ae_int_t n2,
     ae_state *_state);
...
static void wsr_wcheb(float x,
     float c,
     float* tj,
     float* tj1,
     float* r,
     ae_state *_state);
static float wsr_w5(float s, ae_state *_state);
static float wsr_w6(float s, ae_state *_state);
static float wsr_w7(float s, ae_state *_state);
static float wsr_w8(float s, ae_state *_state);
static float wsr_w9(float s, ae_state *_state);
static float wsr_w10(float s, ae_state *_state);
static float wsr_w11(float s, ae_state *_state);
static float wsr_w12(float s, ae_state *_state);
static float wsr_w13(float s, ae_state *_state);
static float wsr_w14(float s, ae_state *_state);
static float wsr_w15(float s, ae_state *_state);
static float wsr_w16(float s, ae_state *_state);
static float wsr_w17(float s, ae_state *_state);
static float wsr_w18(float s, ae_state *_state);
static float wsr_w19(float s, ae_state *_state);
static float wsr_w20(float s, ae_state *_state);
static float wsr_w21(float s, ae_state *_state);
static float wsr_w22(float s, ae_state *_state);
static float wsr_w23(float s, ae_state *_state);
static float wsr_w24(float s, ae_state *_state);
static float wsr_w25(float s, ae_state *_state);
static float wsr_w26(float s, ae_state *_state);
static float wsr_w27(float s, ae_state *_state);
static float wsr_w28(float s, ae_state *_state);
static float wsr_w29(float s, ae_state *_state);
static float wsr_w30(float s, ae_state *_state);
static float wsr_w40(float s, ae_state *_state);
static float wsr_w60(float s, ae_state *_state);
static float wsr_w120(float s, ae_state *_state);
static float wsr_w200(float s, ae_state *_state);
static float wsr_wsigma(float s, ae_int_t n, ae_state *_state);
     ...
     ae_state *_state)
{
    ...
    *mean = *mean/n;
    ...
    if( n!=1 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            v1 = v1+ae_sqr(x->ptr.p_float[i]-(*mean), _state);
        }
        v2 = (float)(0);
        for(i=0; i<=n-1; i++)
        {
            v2 = v2+(x->ptr.p_float[i]-(*mean));
        }
        v2 = ae_sqr(v2, _state)/n;
        *variance = (v1-v2)/(n-1);
        if( ae_fp_less(*variance,(float)(0)) )
        {
            *variance = (float)(0);
        }
     ...
     */
    if( ae_fp_neq(stddev,(float)(0)) )
    {
        for(i=0; i<=n-1; i++)
        {
            v = (x->ptr.p_float[i]-(*mean))/stddev;
            v2 = ae_sqr(v, _state);
...
and stored at 'Mean' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplemean(/* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    float mean;
...
and stored at 'Variance' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplevariance(/* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    float variance;
...
and stored at 'Skewness' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float sampleskewness(/* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    float skewness;
...
and stored at 'Kurtosis' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
float samplekurtosis(/* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    float kurtosis;
     ...
     ae_state *_state)
{
    ...
    *adev = (float)(0);
    ...
    for(i=0; i<=n-1; i++)
    {
        *adev = *adev+ae_fabs(x->ptr.p_float[i]-mean, _state);
    }
    *adev = *adev/n;
}
     ...
     ae_state *_state)
{
    ...
    *median = (float)(0);
    ...
    if( n==1 )
    {
        *median = x->ptr.p_float[0];
        ae_frame_leave(_state);
        return;
    }
    if( n==2 )
    {
        *median = 0.5*(x->ptr.p_float[0]+x->ptr.p_float[1]);
        ae_frame_leave(_state);
        return;
    }
    ...
    for(;;)
    {
        if( ir<=l+1 )
        {
             ...
             */
            if( ir==l+1&&ae_fp_less(x->ptr.p_float[ir],x->ptr.p_float[l]) )
            {
                tval = x->ptr.p_float[l];
                x->ptr.p_float[l] = x->ptr.p_float[ir];
                x->ptr.p_float[ir] = tval;
            }
            break;
        }
        else
        {
            midp = (l+ir)/2;
            tval = x->ptr.p_float[midp];
            x->ptr.p_float[midp] = x->ptr.p_float[l+1];
            x->ptr.p_float[l+1] = tval;
            if( ae_fp_greater(x->ptr.p_float[l],x->ptr.p_float[ir]) )
            {
                tval = x->ptr.p_float[l];
                x->ptr.p_float[l] = x->ptr.p_float[ir];
                x->ptr.p_float[ir] = tval;
            }
            if( ae_fp_greater(x->ptr.p_float[l+1],x->ptr.p_float[ir]) )
            {
                tval = x->ptr.p_float[l+1];
                x->ptr.p_float[l+1] = x->ptr.p_float[ir];
                x->ptr.p_float[ir] = tval;
            }
            if( ae_fp_greater(x->ptr.p_float[l],x->ptr.p_float[l+1]) )
            {
                tval = x->ptr.p_float[l];
                x->ptr.p_float[l] = x->ptr.p_float[l+1];
                x->ptr.p_float[l+1] = tval;
            }
            i = l+1;
            j = ir;
            ...
            for(;;)
            {
                ...
                while(ae_fp_less(x->ptr.p_float[i],a));
                do
                {
                    j = j-1;
                }
                while(ae_fp_greater(x->ptr.p_float[j],a));
                if( j<i )
                {
                    break;
                }
                tval = x->ptr.p_float[i];
                x->ptr.p_float[i] = x->ptr.p_float[j];
                x->ptr.p_float[j] = tval;
            }
            x->ptr.p_float[l+1] = x->ptr.p_float[j];
            x->ptr.p_float[j] = a;
            if( j>=k )
            {
                ir = j-1;
    ...
    for(i=k+1; i<=n-1; i++)
    {
        if( ae_fp_less(x->ptr.p_float[i],a) )
        {
            a = x->ptr.p_float[i];
        }
    }
    *median = 0.5*(x->ptr.p_float[k]+a);
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *v = 0;
    ...
    ae_assert(ae_fp_greater_eq(p,(float)(0))&&ae_fp_less_eq(p,(float)(1)), "SamplePercentile: incorrect P!", _state);
    tagsortfast(x, &rbuf, n, _state);
    if( ae_fp_eq(p,(float)(0)) )
    {
        *v = x->ptr.p_float[0];
        ae_frame_leave(_state);
        return;
    }
    if( ae_fp_eq(p,(float)(1)) )
    {
        *v = x->ptr.p_float[n-1];
        ae_frame_leave(_state);
        return;
    ...
    *v = x->ptr.p_float[i1]*(1-t)+x->ptr.p_float[i1+1]*t;
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        result = result+v*(x->ptr.p_float[i]-xmean)*(y->ptr.p_float[i]-ymean);
    }
    return result;
}
...
Result:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
float pearsoncorr2(/* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        t1 = x->ptr.p_float[i]-xmean;
        t2 = y->ptr.p_float[i]-ymean;
        xv = xv+ae_sqr(t1, _state);
        yv = yv+ae_sqr(t2, _state);
        s = s+t1*t2;
    }
    if( ae_fp_eq(xv,(float)(0))||ae_fp_eq(yv,(float)(0)) )
    {
        result = (float)(0);
    }
    else
...
Result:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float spearmancorr2(/* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     ae_state *_state)
{
     ...
     ae_state *_state)
{
    ...
    ae_v_move(&x0.ptr.p_float[0], 1, &x->ptr.pp_float[0][0], 1, ae_v_len(0,m-1));
    v = (float)1/(float)n;
    for(i=0; i<=n-1; i++)
    {
        ae_v_addd(&t.ptr.p_float[0], 1, &x->ptr.pp_float[i][0], 1, ae_v_len(0,m-1), v);
        for(j=0; j<=m-1; j++)
        {
            same.ptr.p_bool[j] = same.ptr.p_bool[j]&&ae_fp_eq(x->ptr.pp_float[i][j],x0.ptr.p_float[j]);
        }
    }
    ...
    for(i=0; i<=n-1; i++)
    {
        ae_v_sub(&x->ptr.pp_float[i][0], 1, &t.ptr.p_float[0], 1, ae_v_len(0,m-1));
        for(j=0; j<=m-1; j++)
        {
            if( same.ptr.p_bool[j] )
            {
                x->ptr.pp_float[i][j] = (float)(0);
            }
        }
    }
    rmatrixsyrk(m, n, (float)1/(float)(n-1), x, 0, 0, 1, 0.0, c, 0, 0, ae_true, _state);
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=m-1; i++)
    {
        if( ae_fp_greater(c->ptr.pp_float[i][i],(float)(0)) )
        {
            t.ptr.p_float[i] = 1/ae_sqrt(c->ptr.pp_float[i][i], _state);
        }
        else
        {
            t.ptr.p_float[i] = 0.0;
    ...
    for(i=0; i<=m-1; i++)
    {
        ...
        for(j=0; j<=m-1; j++)
        {
            c->ptr.pp_float[i][j] = c->ptr.pp_float[i][j]*v*t.ptr.p_float[j];
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=m-1; i++)
    {
        ...
        v = (float)(0);
        b = ae_true;
        x0 = xc.ptr.pp_float[i][0];
        for(j=0; j<=n-1; j++)
        {
            vv = xc.ptr.pp_float[i][j];
            v = v+vv;
            b = b&&ae_fp_eq(vv,x0);
        }
        v = v/n;
        ...
        else
        {
            ...
            for(j=0; j<=n-1; j++)
            {
                xc.ptr.pp_float[i][j] = xc.ptr.pp_float[i][j]-v;
            }
        }
    }
     ...
     * Calculate upper half of symmetric covariance matrix
     */
    rmatrixsyrk(m, n, (float)1/(float)(n-1), &xc, 0, 0, 0, 0.0, c, 0, 0, ae_true, _state);
     ...
     ae_state *_state)
{
    ...
    ae_v_move(&x0.ptr.p_float[0], 1, &x->ptr.pp_float[0][0], 1, ae_v_len(0,m1-1));
    v = (float)1/(float)n;
    for(i=0; i<=n-1; i++)
    {
        ae_v_addd(&t.ptr.p_float[0], 1, &x->ptr.pp_float[i][0], 1, ae_v_len(0,m1-1), v);
        for(j=0; j<=m1-1; j++)
        {
            samex.ptr.p_bool[j] = samex.ptr.p_bool[j]&&ae_fp_eq(x->ptr.pp_float[i][j],x0.ptr.p_float[j]);
        }
    }
    for(i=0; i<=n-1; i++)
    {
        ae_v_sub(&x->ptr.pp_float[i][0], 1, &t.ptr.p_float[0], 1, ae_v_len(0,m1-1));
        for(j=0; j<=m1-1; j++)
        {
    ...
    ae_v_move(&y0.ptr.p_float[0], 1, &y->ptr.pp_float[0][0], 1, ae_v_len(0,m2-1));
    v = (float)1/(float)n;
    for(i=0; i<=n-1; i++)
    {
        ae_v_addd(&t.ptr.p_float[0], 1, &y->ptr.pp_float[i][0], 1, ae_v_len(0,m2-1), v);
        for(j=0; j<=m2-1; j++)
        {
            samey.ptr.p_bool[j] = samey.ptr.p_bool[j]&&ae_fp_eq(y->ptr.pp_float[i][j],y0.ptr.p_float[j]);
        }
    }
    for(i=0; i<=n-1; i++)
    {
        ae_v_sub(&y->ptr.pp_float[i][0], 1, &t.ptr.p_float[0], 1, ae_v_len(0,m2-1));
        for(j=0; j<=m2-1; j++)
        {
            if( samey.ptr.p_bool[j] )
            {
                y->ptr.pp_float[i][j] = (float)(0);
            }
        }
    }
     ...
     */
    rmatrixgemm(m1, m2, n, (float)1/(float)(n-1), x, 0, 0, 1, y, 0, 0, 0, 0.0, c, 0, 0, _state);
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        ...
        for(j=0; j<=m1-1; j++)
        {
            ...
            sx.ptr.p_float[j] = sx.ptr.p_float[j]+x->ptr.pp_float[i][j]*x->ptr.pp_float[i][j];
        }
    }
    for(j=0; j<=m1-1; j++)
    {
        sx.ptr.p_float[j] = ae_sqrt(sx.ptr.p_float[j]/(n-1), _state);
    }
    ...
    for(i=0; i<=n-1; i++)
    {
        ...
        for(j=0; j<=m2-1; j++)
        {
            ...
            sy.ptr.p_float[j] = sy.ptr.p_float[j]+y->ptr.pp_float[i][j]*y->ptr.pp_float[i][j];
        }
    }
    for(j=0; j<=m2-1; j++)
    {
        sy.ptr.p_float[j] = ae_sqrt(sy.ptr.p_float[j]/(n-1), _state);
    }
    ...
    for(i=0; i<=m1-1; i++)
    {
        if( ae_fp_neq(sx.ptr.p_float[i],(float)(0)) )
        {
            sx.ptr.p_float[i] = 1/sx.ptr.p_float[i];
        }
        else
        {
            sx.ptr.p_float[i] = 0.0;
        }
    }
    for(i=0; i<=m2-1; i++)
    {
        if( ae_fp_neq(sy.ptr.p_float[i],(float)(0)) )
        {
            sy.ptr.p_float[i] = 1/sy.ptr.p_float[i];
        }
        else
        {
            sy.ptr.p_float[i] = 0.0;
        }
    }
    for(i=0; i<=m1-1; i++)
    {
        ...
        for(j=0; j<=m2-1; j++)
        {
            c->ptr.pp_float[i][j] = c->ptr.pp_float[i][j]*v*sy.ptr.p_float[j];
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=m1-1; i++)
    {
        ...
        else
        {
            ...
            {
                vv = xc.ptr.pp_float[i][j];
                xc.ptr.pp_float[i][j] = vv-v;
                v2 = v2+(vv-v)*(vv-v);
            }
        }
        sx.ptr.p_float[i] = ae_sqrt(v2/(n-1), _state);
    }
    for(i=0; i<=m2-1; i++)
    {
        v = (float)(0);
        v2 = 0.0;
        b = ae_true;
        y0 = yc.ptr.pp_float[i][0];
        for(j=0; j<=n-1; j++)
        {
            vv = yc.ptr.pp_float[i][j];
            v = v+vv;
            b = b&&ae_fp_eq(vv,y0);
        }
        v = v/n;
        ...
        else
        {
            ...
            {
                vv = yc.ptr.pp_float[i][j];
                yc.ptr.pp_float[i][j] = vv-v;
                v2 = v2+(vv-v)*(vv-v);
            }
        }
        sy.ptr.p_float[i] = ae_sqrt(v2/(n-1), _state);
    }
    
    /*
     * calculate cross-covariance matrix
     */
    rmatrixgemm(m1, m2, n, (float)1/(float)(n-1), &xc, 0, 0, 0, &yc, 0, 0, 1, 0.0, c, 0, 0, _state);
     ...
     ae_state *_state)
{
     ...
     */
    if( ae_fp_less(inttoreal(npoints, _state)*inttoreal(nfeatures, _state)*logbase2((float)(nfeatures), _state),(float)(basecasecost)) )
    {
...
Obsolete function, we recommend to use PearsonCorr2().
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float pearsoncorrelation(/* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     ae_state *_state)
{
...
Obsolete function, we recommend to use SpearmanCorr2().
    ...
    Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
float spearmanrankcorrelation(/* Real    */ ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     ae_state *_state)
{
     ...
     ae_state *_state)
{
     ...
     */
    problemcost = inttoreal(i1-i0, _state)*inttoreal(nfeatures, _state)*logbase2((float)(nfeatures), _state);
    if( i1-i0>=2&&ae_fp_greater(problemcost,(float)(basecasecost)) )
    {
        im = (i1+i0)/2;
     ...
     ae_state *_state)
{
    ...
    for(i=i0; i<=i1-1; i++)
    {
        ae_v_move(&buf1->ra0.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nfeatures-1));
        rankx(&buf1->ra0, nfeatures, iscentered, buf0, _state);
        ae_v_move(&xy->ptr.pp_float[i][0], 1, &buf1->ra0.ptr.p_float[0], 1, ae_v_len(0,nfeatures-1));
    }
}
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void pearsoncorrelationsignificance(float r,
     ae_int_t n,
     float* bothtails,
     float* lefttail,
     float* righttail,
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
void spearmanrankcorrelationsignificance(float r,
     ae_int_t n,
     float* bothtails,
     float* lefttail,
     float* righttail,
     ...
     ae_state *_state)
{
    ...
    *s = 0;
     ...
     * Statistic
     */
    *s = (float)n/(float)6*(ae_sqr(skewness, _state)+ae_sqr(kurtosis, _state)/4);
}
     ...
     ae_state *_state)
{
    ...
    if( n>20&&n<=50 )
    {
        ...
        if( ae_fp_greater(result,(float)(0)) )
        {
            result = (float)(0);
        }
    ...
    if( n>1401 )
    {
        result = -0.5*x+(jarquebera_jbtbl1401(x, _state)+0.5*x)*ae_sqrt((float)1401/(float)n, _state);
        if( ae_fp_greater(result,(float)(0)) )
        {
            result = (float)(0);
        }
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        r.ptr.p_float[i] = x->ptr.p_float[i];
        c.ptr.p_int[i] = 0;
    }
    for(i=0; i<=m-1; i++)
    {
        r.ptr.p_float[n+i] = y->ptr.p_float[i];
        c.ptr.p_int[n+i] = 1;
    }
    ...
    if( ns!=1 )
    {
        ...
        do
        {
            ...
            {
                k = t/2;
                if( ae_fp_greater_eq(r.ptr.p_float[k-1],r.ptr.p_float[t-1]) )
                {
                    t = 1;
                }
                else
                {
                    tmp = r.ptr.p_float[k-1];
                    r.ptr.p_float[k-1] = r.ptr.p_float[t-1];
                    r.ptr.p_float[t-1] = tmp;
        ...
        {
            tmp = r.ptr.p_float[i];
            r.ptr.p_float[i] = r.ptr.p_float[0];
            r.ptr.p_float[0] = tmp;
            tmpi = c.ptr.p_int[i];
            ...
            while(t!=0)
            {
                ...
                else
                {
                    if( k<i )
                    {
                        if( ae_fp_greater(r.ptr.p_float[k],r.ptr.p_float[k-1]) )
                        {
                            k = k+1;
                        }
                    }
                    if( ae_fp_greater_eq(r.ptr.p_float[t-1],r.ptr.p_float[k-1]) )
                    {
                        t = 0;
                    }
                    else
    ...
    while(i<=ns-1)
    {
        ...
        while(j<=ns-1)
        {
            if( ae_fp_neq(r.ptr.p_float[j],r.ptr.p_float[i]) )
            {
                break;
            }
            j = j+1;
        ...
        for(k=i; k<=j-1; k++)
        {
            r.ptr.p_float[k] = 1+(float)(i+j-1)/(float)2;
        }
     ...
     * Result
     */
    mu = (float)(n*m)/(float)2;
    tmp = ns*(ae_sqr((float)(ns), _state)-1)/12;
    for(i=0; i<=tiecount-1; i++)
    {
        tmp = tmp-tiesize.ptr.p_int[i]*(ae_sqr((float)(tiesize.ptr.p_int[i]), _state)-1)/12;
    }
    sigma = ae_sqrt((float)(m*n)/(float)ns/(ns-1)*tmp, _state);
    s = (u-mu)/sigma;
    if( ae_fp_less_eq(s,(float)(0)) )
    {
     ...
     ae_state *_state)
{
     ...
     * N1 >= 15, N2 >= 15
     */
    if( ae_fp_greater(s,(float)(4)) )
    {
        s = (float)(4);
    }
    if( ae_fp_less(s,(float)(3)) )
    {
        s0 = 0.000000e+00;
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_greater(x->ptr.p_float[i],median) )
        {
            gtcnt = gtcnt+1;
        }
        if( ae_fp_neq(x->ptr.p_float[i],median) )
        {
            necnt = necnt+1;
        }
    }
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    if( n!=1&&!samex )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            v1 = v1+ae_sqr(x->ptr.p_float[i]-xmean, _state);
        }
        v2 = (float)(0);
        for(i=0; i<=n-1; i++)
        {
            v2 = v2+(x->ptr.p_float[i]-xmean);
        }
        v2 = ae_sqr(v2, _state)/n;
        xvariance = (v1-v2)/(n-1);
        if( ae_fp_less(xvariance,(float)(0)) )
        {
            xvariance = (float)(0);
        }
        xstddev = ae_sqrt(xvariance, _state);
    }
    if( ae_fp_eq(xstddev,(float)(0)) )
    {
     ...
     * Statistic
     */
    stat = (xmean-mean)/(xstddev/ae_sqrt((float)(n), _state));
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    if( n+m>2 )
    {
        for(i=0; i<=n-1; i++)
        {
            s = s+ae_sqr(x->ptr.p_float[i]-xmean, _state);
        }
        for(i=0; i<=m-1; i++)
        {
            s = s+ae_sqr(y->ptr.p_float[i]-ymean, _state);
        }
        s = ae_sqrt(s*((float)1/(float)n+(float)1/(float)m)/(n+m-2), _state);
    }
    if( ae_fp_eq(s,(float)(0)) )
    {
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    if( n>=2&&!samex )
    {
        for(i=0; i<=n-1; i++)
        {
            xvar = xvar+ae_sqr(x->ptr.p_float[i]-xmean, _state);
        }
        xvar = xvar/(n-1);
    }
    yvar = (float)(0);
    if( m>=2&&!samey )
    {
        for(i=0; i<=m-1; i++)
        {
            yvar = yvar+ae_sqr(y->ptr.p_float[i]-ymean, _state);
        }
        yvar = yvar/(m-1);
    }
     ...
     */
    if( ae_fp_eq(xvar,(float)(0))&&ae_fp_eq(yvar,(float)(0)) )
    {
        if( ae_fp_eq(xmean,ymean) )
        {
            *bothtails = 1.0;
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        xmean = xmean+x->ptr.p_float[i];
    }
    xmean = xmean/n;
    ymean = (float)(0);
    for(i=0; i<=m-1; i++)
    {
        ymean = ymean+y->ptr.p_float[i];
    }
    ymean = ymean/m;
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    s = chisquaredistribution((float)(n-1), stat, _state);
    *bothtails = 2*ae_minreal(s, 1-s, _state);
    *lefttail = s;
    *righttail = 1-(*lefttail);
}
     ...
     ae_state *_state)
{
    ...
    *righttail = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(x->ptr.p_float[i],e) )
        {
            continue;
        }
        x->ptr.p_float[ns] = x->ptr.p_float[i];
        ns = ns+1;
    }
    if( ns<5 )
    {
    ...
    for(i=0; i<=ns-1; i++)
    {
        r.ptr.p_float[i] = ae_fabs(x->ptr.p_float[i]-e, _state);
        c.ptr.p_int[i] = i;
    }
    ...
    for(i=0; i<=ns-1; i++)
    {
        if( ae_fp_greater(x->ptr.p_float[c.ptr.p_int[i]],e) )
        {
            w = w+r.ptr.p_float[i];
        }
    }
     ...
     * Result
     */
    mu = (float)(ns*(ns+1))/(float)4;
    sigma = ae_sqrt((float)(ns*(ns+1)*(2*ns+1))/(float)24, _state);
    s = (w-mu)/sigma;
    if( ae_fp_less_eq(s,(float)(0)) )
    {
