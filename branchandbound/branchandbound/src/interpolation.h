...
typedef struct
{
    ...
    float debugworstrcond;
    float debugbestrcond;
} idwinterpolant;
typedef struct
{
    ae_int_t n;
...
*************************************************************************/
float idwcalc(const idwinterpolant &z, const real_1d_array &x);
...
*************************************************************************/
void idwbuildmodifiedshepardr(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const float r, idwinterpolant &z);
...
*************************************************************************/
float barycentriccalc(const barycentricinterpolant &b, const float t);
...
NOTE
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
void barycentricdiff1(const barycentricinterpolant &b, const float t, float &f, float &df);
...
BarycentricDiff1() subroutine in such cases.
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
void barycentricdiff2(const barycentricinterpolant &b, const float t, float &f, float &df, float &d2f);
...
*************************************************************************/
void barycentriclintransx(const barycentricinterpolant &b, const float ca, const float cb);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 19.08.2009 by Bochkanov Sergey
*************************************************************************/
void barycentriclintransy(const barycentricinterpolant &b, const float ca, const float cb);
...
*************************************************************************/
void polynomialbar2cheb(const barycentricinterpolant &p, const float a, const float b, real_1d_array &t);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
void polynomialcheb2bar(const real_1d_array &t, const ae_int_t n, const float a, const float b, barycentricinterpolant &p);
void polynomialcheb2bar(const real_1d_array &t, const float a, const float b, barycentricinterpolant &p);
...
3.  barycentric interpolant passed as P may be either polynomial  obtained
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
void polynomialbar2pow(const barycentricinterpolant &p, const float c, const float s, real_1d_array &a);
...
2.  power basis is ill-conditioned and tricks described above can't  solve
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
void polynomialpow2bar(const real_1d_array &a, const ae_int_t n, const float c, const float s, barycentricinterpolant &p);
...
*************************************************************************/
void polynomialbuildeqdist(const float a, const float b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
void polynomialbuildeqdist(const float a, const float b, const real_1d_array &y, barycentricinterpolant &p);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 03.12.2009 by Bochkanov Sergey
*************************************************************************/
void polynomialbuildcheb1(const float a, const float b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
void polynomialbuildcheb1(const float a, const float b, const real_1d_array &y, barycentricinterpolant &p);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 03.12.2009 by Bochkanov Sergey
*************************************************************************/
void polynomialbuildcheb2(const float a, const float b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
void polynomialbuildcheb2(const float a, const float b, const real_1d_array &y, barycentricinterpolant &p);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float polynomialcalceqdist(const float a, const float b, const real_1d_array &f, const ae_int_t n, const float t);
float polynomialcalceqdist(const float a, const float b, const real_1d_array &f, const float t);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float polynomialcalccheb1(const float a, const float b, const real_1d_array &f, const ae_int_t n, const float t);
float polynomialcalccheb1(const float a, const float b, const real_1d_array &f, const float t);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float polynomialcalccheb2(const float a, const float b, const real_1d_array &f, const ae_int_t n, const float t);
float polynomialcalccheb2(const float a, const float b, const real_1d_array &f, const float t);
...
*************************************************************************/
void spline1dbuildcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, spline1dinterpolant &c);
...
*************************************************************************/
void spline1dgriddiffcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, real_1d_array &d);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
void spline1dgriddiff2cubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, real_1d_array &d1, real_1d_array &d2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
void spline1dconvcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
void spline1dconvdiffcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2, real_1d_array &d2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
void spline1dconvdiff2cubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const float boundl, const ae_int_t boundrtype, const float boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2, real_1d_array &d2, real_1d_array &dd2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
void spline1dbuildcatmullrom(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundtype, const float tension, spline1dinterpolant &c);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
float spline1dcalc(const spline1dinterpolant &c, const float x);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 24.06.2007 by Bochkanov Sergey
*************************************************************************/
void spline1ddiff(const spline1dinterpolant &c, const float x, float &s, float &ds, float &d2s);
...
*************************************************************************/
void spline1dlintransx(const spline1dinterpolant &c, const float a, const float b);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
void spline1dlintransy(const spline1dinterpolant &c, const float a, const float b);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
float spline1dintegrate(const spline1dinterpolant &c, const float x);
...
NOTE: X2/Y2 are ordered arrays, i.e. (X2[0],Y2[0]) is  a  first  point  of
  ...
  -- ALGLIB --
     Copyright 02.10.2014 by Bochkanov Sergey
*************************************************************************/
void lstfitpiecewiselinearrdp(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const float eps, real_1d_array &x2, real_1d_array &y2, ae_int_t &nsections);
...
*************************************************************************/
float logisticcalc4(const float x, const float a, const float b, const float c, const float d);
...
NOTE: this function performs a lot of checks;  if  you  need  really  high
  ...
  -- ALGLIB PROJECT --
     Copyright 14.05.2014 by Bochkanov Sergey
*************************************************************************/
float logisticcalc5(const float x, const float a, const float b, const float c, const float d, const float g);
...
*************************************************************************/
void logisticfit4(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, float &a, float &b, float &c, float &d, lsfitreport &rep);
...
INPUT PARAMETERS:
    ...
    CnstrRight- optional equality constraint for model value at X=infinity.
                ...
                parameter, in  C# it will  be float.NaN).
                See  below,  section  "EQUALITY  CONSTRAINTS"   for   more
                information about constraints.
...
D. That's because 4PL model is normalized in such way that B>=0.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
void logisticfit4ec(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const float cnstrleft, const float cnstrright, float &a, float &b, float &c, float &d, lsfitreport &rep);
...
NOTE: step is automatically scaled according to scale of parameters  being
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
void logisticfit5(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, float &a, float &b, float &c, float &d, float &g, lsfitreport &rep);
...
question highlighted above is important when you interpret fitting results.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
void logisticfit5ec(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const float cnstrleft, const float cnstrright, float &a, float &b, float &c, float &d, float &g, lsfitreport &rep);
...
question highlighted above is important when you interpret fitting results.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
void logisticfit45x(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const float cnstrleft, const float cnstrright, const bool is4pl, const float lambdav, const float epsx, const ae_int_t rscnt, float &a, float &b, float &c, float &d, float &g, lsfitreport &rep);
...
array.
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
void spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void smp_spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void smp_spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
*************************************************************************/
void spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void smp_spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
void smp_spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t m, const float rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
*************************************************************************/
void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const float diffstep, lsfitstate &state);
void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const float diffstep, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.10.2008 by Bochkanov Sergey
*************************************************************************/
void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const float diffstep, lsfitstate &state);
void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const float diffstep, lsfitstate &state);
...
stopping criterion selection (according to the scheme used by MINLM unit).
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
void lsfitsetcond(const lsfitstate &state, const float epsf, const float epsx, const ae_int_t maxits);
...
*************************************************************************/
void lsfitsetstpmax(const lsfitstate &state, const float stpmax);
...
void lsfitfit(lsfitstate &state,
    void (*func)(const real_1d_array &c, const real_1d_array &x, float &func, void *ptr),
    void  (*rep)(const real_1d_array &c, float func, void *ptr) = NULL,
    void *ptr = NULL);
void lsfitfit(lsfitstate &state,
    void (*func)(const real_1d_array &c, const real_1d_array &x, float &func, void *ptr),
    void (*grad)(const real_1d_array &c, const real_1d_array &x, float &func, real_1d_array &grad, void *ptr),
    void  (*rep)(const real_1d_array &c, float func, void *ptr) = NULL,
    void *ptr = NULL);
void lsfitfit(lsfitstate &state,
    void (*func)(const real_1d_array &c, const real_1d_array &x, float &func, void *ptr),
    void (*grad)(const real_1d_array &c, const real_1d_array &x, float &func, real_1d_array &grad, void *ptr),
    void (*hess)(const real_1d_array &c, const real_1d_array &x, float &func, real_1d_array &grad, real_2d_array &hess, void *ptr),
    void  (*rep)(const real_1d_array &c, float func, void *ptr) = NULL,
    void *ptr = NULL);
...
*************************************************************************/
void lsfitsetgradientcheck(const lsfitstate &state, const float teststep);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline2calc(const pspline2interpolant &p, const float t, float &x, float &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline3calc(const pspline3interpolant &p, const float t, float &x, float &y, float &z);
...
NOTE:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline2tangent(const pspline2interpolant &p, const float t, float &x, float &y);
...
NOTE:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline3tangent(const pspline3interpolant &p, const float t, float &x, float &y, float &z);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline2diff(const pspline2interpolant &p, const float t, float &x, float &dx, float &y, float &dy);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline3diff(const pspline3interpolant &p, const float t, float &x, float &dx, float &y, float &dy, float &z, float &dz);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline2diff2(const pspline2interpolant &p, const float t, float &x, float &dx, float &d2x, float &y, float &dy, float &d2y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
void pspline3diff2(const pspline3interpolant &p, const float t, float &x, float &dx, float &d2x, float &y, float &dy, float &d2y, float &z, float &dz, float &d2z);
...
*************************************************************************/
float pspline2arclength(const pspline2interpolant &p, const float a, const float b);
...
RESULT:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.05.2010 by Bochkanov Sergey
*************************************************************************/
float pspline3arclength(const pspline3interpolant &p, const float a, const float b);
...
NOTE: algorithm stops after:
  ...
  -- ALGLIB --
     Copyright 02.10.2014 by Bochkanov Sergey
*************************************************************************/
void parametricrdpfixed(const real_2d_array &x, const ae_int_t n, const ae_int_t d, const ae_int_t stopm, const float stopeps, real_2d_array &x2, integer_1d_array &idx2, ae_int_t &nsections);
...
NOTE 1: memory requirements. RBF models require amount of memory  which is
        ...
        given below:
        * about 250*N*(sizeof(float)+2*sizeof(int)) bytes  of  memory  is
          needed during model construction stage.
        * about 15*N*sizeof(float) bytes is needed after model is built.
...
NOTE: this   function  has   some   serialization-related  subtleties.  We
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
void rbfsetalgoqnn(const rbfmodel &s, const float q, const float z);
...
*************************************************************************/
void rbfsetalgomultilayer(const rbfmodel &s, const float rbase, const ae_int_t nlayers, const float lambdav);
void rbfsetalgomultilayer(const rbfmodel &s, const float rbase, const ae_int_t nlayers);
...
RESULT:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
float rbfcalc2(const rbfmodel &s, const float x0, const float x1);
...
RESULT:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
float rbfcalc3(const rbfmodel &s, const float x0, const float x1, const float x2);
...
*************************************************************************/
float spline2dcalc(const spline2dinterpolant &c, const float x, const float y);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 05.07.2007 by Bochkanov Sergey
*************************************************************************/
void spline2ddiff(const spline2dinterpolant &c, const float x, const float y, float &f, float &fx, float &fy, float &fxy);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
void spline2dlintransxy(const spline2dinterpolant &c, const float ax, const float bx, const float ay, const float by);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
void spline2dlintransf(const spline2dinterpolant &c, const float a, const float b);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline2dcalcvbuf(const spline2dinterpolant &c, const float x, const float y, real_1d_array &f);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline2dcalcv(const spline2dinterpolant &c, const float x, const float y, real_1d_array &f);
...
*************************************************************************/
float spline3dcalc(const spline3dinterpolant &c, const float x, const float y, const float z);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline3dlintransxyz(const spline3dinterpolant &c, const float ax, const float bx, const float ay, const float by, const float az, const float bz);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline3dlintransf(const spline3dinterpolant &c, const float a, const float b);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline3dcalcvbuf(const spline3dinterpolant &c, const float x, const float y, const float z, real_1d_array &f);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
void spline3dcalcv(const spline3dinterpolant &c, const float x, const float y, const float z, real_1d_array &f);
...
namespace alglib_impl
{
float idwcalc(idwinterpolant* z,
     /* Real    */ ae_vector* x,
     ae_state *_state);
...
float barycentriccalc(barycentricinterpolant* b,
     float t,
     ae_state *_state);
...
void polynomialbuild(/* Real    */ ae_vector* x,
     ...
     barycentricinterpolant* p,
     ae_state *_state);
void polynomialbuildeqdist(float a,
     float b,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     barycentricinterpolant* p,
     ae_state *_state);
void polynomialbuildcheb1(float a,
     float b,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     barycentricinterpolant* p,
     ae_state *_state);
void polynomialbuildcheb2(float a,
     float b,
     /* Real    */ ae_vector* y,
     ae_int_t n,
     barycentricinterpolant* p,
     ae_state *_state);
float polynomialcalceqdist(float a,
     float b,
     /* Real    */ ae_vector* f,
     ae_int_t n,
     float t,
     ae_state *_state);
float polynomialcalccheb1(float a,
     float b,
     /* Real    */ ae_vector* f,
     ae_int_t n,
     float t,
     ae_state *_state);
float polynomialcalccheb2(float a,
     float b,
     /* Real    */ ae_vector* f,
     ae_int_t n,
     float t,
...
void spline1dbuildakima(/* Real    */ ae_vector* x,
     ...
     spline1dinterpolant* c,
     ae_state *_state);
float spline1dcalc(spline1dinterpolant* c, float x, ae_state *_state);
...
void spline1dlintransy(spline1dinterpolant* c,
     ...
     float b,
     ae_state *_state);
float spline1dintegrate(spline1dinterpolant* c,
     float x,
     ae_state *_state);
...
void solvepolinom2(float p0,
     ...
     ae_int_t* nr,
     ae_state *_state);
void solvecubicpolinom(float pa,
     float ma,
     float pb,
     float mb,
     float a,
     ...
     ae_state *_state);
ae_int_t bisectmethod(float pa,
     float ma,
     float pb,
     float mb,
     float a,
...
void _pexec_polynomialfitwc(/* Real    */ ae_vector* x,
    ...
    barycentricinterpolant* p,
    polynomialfitreport* rep, ae_state *_state);
float logisticcalc4(float x,
     float a,
     float b,
     float c,
     float d,
     ae_state *_state);
float logisticcalc5(float x,
     float a,
     float b,
     float c,
     float d,
...
void lsfitsetcond(lsfitstate* state,
     ...
     ae_int_t maxits,
     ae_state *_state);
void lsfitsetstpmax(lsfitstate* state, float stpmax, ae_state *_state);
...
void pspline3diff2(pspline3interpolant* p,
     ...
     float* d2z,
     ae_state *_state);
float pspline2arclength(pspline2interpolant* p,
     float a,
     float b,
     ae_state *_state);
float pspline3arclength(pspline3interpolant* p,
     float a,
     float b,
     ae_state *_state);
...
void rbfsetpoints(rbfmodel* s,
     ...
     ae_int_t n,
     ae_state *_state);
void rbfsetalgoqnn(rbfmodel* s, float q, float z, ae_state *_state);
...
float rbfcalc2(rbfmodel* s, float x0, float x1, ae_state *_state);
float rbfcalc3(rbfmodel* s,
     float x0,
     float x1,
     float x2,
     ae_state *_state);
...
float spline2dcalc(spline2dinterpolant* c,
     float x,
     float y,
     ae_state *_state);
...
float spline3dcalc(spline3dinterpolant* c,
     float x,
     float y,
     float z,
     ae_state *_state);
