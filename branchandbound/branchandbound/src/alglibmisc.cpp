...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float hqrnduniformr(const hqrndstate &state)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::hqrnduniformr(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float hqrndnormal(const hqrndstate &state)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::hqrndnormal(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndunit2(const hqrndstate &state, float &x, float &y)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndnormal2(const hqrndstate &state, float &x1, float &x2)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
*************************************************************************/
float hqrndexponential(const hqrndstate &state, const float lambdav)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::hqrndexponential(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), lambdav, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
*************************************************************************/
float hqrnddiscrete(const hqrndstate &state, const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::hqrnddiscrete(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
float hqrndcontinuous(const hqrndstate &state, const real_1d_array &x, const ae_int_t n)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::hqrndcontinuous(const_cast<alglib_impl::hqrndstate*>(state.c_ptr()), const_cast<alglib_impl::ae_vector*>(x.c_ptr()), n, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const float r, const bool selfmatch)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const float r)
{
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const float eps)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const float eps)
{
    alglib_impl::ae_state _alglib_env_state;    
    bool selfmatch;
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugr1sum(const real_1d_array &a)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::xdebugr1sum(const_cast<alglib_impl::ae_vector*>(a.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugr2sum(const real_2d_array &a)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::xdebugr2sum(const_cast<alglib_impl::ae_matrix*>(a.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugmaskedbiasedproductsum(const ae_int_t m, const ae_int_t n, const real_2d_array &a, const real_2d_array &b, const boolean_2d_array &c)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::xdebugmaskedbiasedproductsum(m, n, const_cast<alglib_impl::ae_matrix*>(a.c_ptr()), const_cast<alglib_impl::ae_matrix*>(b.c_ptr()), const_cast<alglib_impl::ae_matrix*>(c.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float hqrnduniformr(hqrndstate* state, ae_state *_state)
{
    float result;


    result = (float)(hqrnd_hqrndintegerbase(state, _state)+1)/(float)(hqrnd_hqrndmax+2);
    return result;
}
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
float hqrndnormal(hqrndstate* state, ae_state *_state)
{
    float v1;
    float v2;
    float result;
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
void hqrndunit2(hqrndstate* state, float* x, float* y, ae_state *_state)
{
    float v;
    float mx;
    float mn;
    ...
    *y = 0;
    ...
    while(!(ae_fp_neq(*x,(float)(0))||ae_fp_neq(*y,(float)(0))));
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 11.08.2007 by Bochkanov Sergey
*************************************************************************/
float hqrndexponential(hqrndstate* state,
     float lambdav,
     ae_state *_state)
{
    float result;
    ...
    ae_assert(ae_fp_greater(lambdav,(float)(0)), "HQRNDExponential: LambdaV<=0!", _state);
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
float hqrnddiscrete(hqrndstate* state,
     /* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    ...
    result = x->ptr.p_float[hqrnduniformi(state, n, _state)];
    return result;
}
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
float hqrndcontinuous(hqrndstate* state,
     /* Real    */ ae_vector* x,
     ae_int_t n,
     ae_state *_state)
{
    ...
    if( n==1 )
    {
        result = x->ptr.p_float[0];
        return result;
    }
    i = hqrnduniformi(state, n-1, _state);
    mn = x->ptr.p_float[i];
    mx = x->ptr.p_float[i+1];
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        ae_v_move(&kdt->xy.ptr.pp_float[i][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nx-1));
        ae_v_move(&kdt->xy.ptr.pp_float[i][nx], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(nx,2*nx+ny-1));
     ...
     */
    ae_v_move(&kdt->boxmin.ptr.p_float[0], 1, &kdt->xy.ptr.pp_float[0][0], 1, ae_v_len(0,nx-1));
    ae_v_move(&kdt->boxmax.ptr.p_float[0], 1, &kdt->xy.ptr.pp_float[0][0], 1, ae_v_len(0,nx-1));
    for(i=1; i<=n-1; i++)
    {
        for(j=0; j<=nx-1; j++)
        {
            kdt->boxmin.ptr.p_float[j] = ae_minreal(kdt->boxmin.ptr.p_float[j], kdt->xy.ptr.pp_float[i][j], _state);
            kdt->boxmax.ptr.p_float[j] = ae_maxreal(kdt->boxmax.ptr.p_float[j], kdt->xy.ptr.pp_float[i][j], _state);
        }
    }
    ...
    nodesoffs = 0;
    splitsoffs = 0;
    ae_v_move(&kdt->curboxmin.ptr.p_float[0], 1, &kdt->boxmin.ptr.p_float[0], 1, ae_v_len(0,nx-1));
    ae_v_move(&kdt->curboxmax.ptr.p_float[0], 1, &kdt->boxmax.ptr.p_float[0], 1, ae_v_len(0,nx-1));
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(r,(float)(0)), "KDTreeQueryRNN: incorrect R!", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(eps,(float)(0)), "KDTreeQueryAKNN: incorrect Eps!", _state);
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=k-1; i++)
    {
        ae_v_move(&x->ptr.pp_float[i][0], 1, &kdt->xy.ptr.pp_float[kdt->idx.ptr.p_int[i]][kdt->nx], 1, ae_v_len(0,kdt->nx-1));
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=k-1; i++)
    {
        ae_v_move(&xy->ptr.pp_float[i][0], 1, &kdt->xy.ptr.pp_float[kdt->idx.ptr.p_int[i]][kdt->nx], 1, ae_v_len(0,kdt->nx+kdt->ny-1));
    }
}
     ...
     ae_state *_state)
{
    ...
    if( kdt->normtype==0 )
    {
        for(i=0; i<=k-1; i++)
        {
            r->ptr.p_float[i] = ae_fabs(kdt->r.ptr.p_float[i], _state);
        }
    }
    if( kdt->normtype==1 )
    {
    ...
    if( kdt->normtype==2 )
    {
        for(i=0; i<=k-1; i++)
        {
            r->ptr.p_float[i] = ae_sqrt(ae_fabs(kdt->r.ptr.p_float[i], _state), _state);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    *i3 = 0;
    ...
    while(ileft<iright)
    {
        if( ae_fp_less_eq(kdt->xy.ptr.pp_float[ileft][d],s) )
        {
        ...
        else
        {
            ...
            {
                v = kdt->xy.ptr.pp_float[ileft][i];
                kdt->xy.ptr.pp_float[ileft][i] = kdt->xy.ptr.pp_float[iright][i];
                kdt->xy.ptr.pp_float[iright][i] = v;
            }
     ...
     ae_state *_state)
{
     ...
     */
    d = 0;
    ds = kdt->curboxmax.ptr.p_float[0]-kdt->curboxmin.ptr.p_float[0];
    for(i=1; i<=nx-1; i++)
    {
        v = kdt->curboxmax.ptr.p_float[i]-kdt->curboxmin.ptr.p_float[i];
     ...
     */
    s = kdt->curboxmin.ptr.p_float[d]+0.5*ds;
    ae_v_move(&kdt->buf.ptr.p_float[0], 1, &kdt->xy.ptr.pp_float[i1][d], kdt->xy.stride, ae_v_len(0,i2-i1-1));
    n = i2-i1;
    cntless = 0;
    cntgreater = 0;
    minv = kdt->buf.ptr.p_float[0];
    maxv = kdt->buf.ptr.p_float[0];
    minidx = i1;
    maxidx = i1;
    for(i=0; i<=n-1; i++)
    {
        v = kdt->buf.ptr.p_float[i];
    ...
    if( ae_fp_eq(minv,maxv) )
    {
         ...
         * box to become exactly zero and repeat tree construction.
         */
        v0 = kdt->curboxmin.ptr.p_float[d];
        v1 = kdt->curboxmax.ptr.p_float[d];
        kdt->curboxmin.ptr.p_float[d] = minv;
        kdt->curboxmax.ptr.p_float[d] = maxv;
        nearestneighbor_kdtreegeneratetreerec(kdt, nodesoffs, splitsoffs, i1, i2, maxleafsize, _state);
        kdt->curboxmin.ptr.p_float[d] = v0;
        kdt->curboxmax.ptr.p_float[d] = v1;
        return;
    }
    ...
    else
    {
        ...
        if( cntless==0 )
        {
            ...
            if( minidx!=i1 )
            {
                ...
                {
                    v = kdt->xy.ptr.pp_float[minidx][i];
                    kdt->xy.ptr.pp_float[minidx][i] = kdt->xy.ptr.pp_float[i1][i];
                    kdt->xy.ptr.pp_float[i1][i] = v;
                }
        ...
        else
        {
            ...
            if( maxidx!=i2-1 )
            {
                for(i=0; i<=2*nx+ny-1; i++)
                {
                    v = kdt->xy.ptr.pp_float[maxidx][i];
                    kdt->xy.ptr.pp_float[maxidx][i] = kdt->xy.ptr.pp_float[i2-1][i];
                    kdt->xy.ptr.pp_float[i2-1][i] = v;
                }
    ...
    kdt->splits.ptr.p_float[*splitsoffs+0] = s;
    oldoffs = *nodesoffs;
     ...
     ae_state *_state)
{
    ...
    if( kdt->nodes.ptr.p_int[offs]>0 )
    {
        ...
        for(i=i1; i<=i2-1; i++)
        {
            ...
            if( kdt->normtype==0 )
            {
                for(j=0; j<=nx-1; j++)
                {
                    ptdist = ae_maxreal(ptdist, ae_fabs(kdt->xy.ptr.pp_float[i][j]-kdt->x.ptr.p_float[j], _state), _state);
                }
            }
            if( kdt->normtype==1 )
            {
                for(j=0; j<=nx-1; j++)
                {
                    ptdist = ptdist+ae_fabs(kdt->xy.ptr.pp_float[i][j]-kdt->x.ptr.p_float[j], _state);
                }
            }
            if( kdt->normtype==2 )
            {
                for(j=0; j<=nx-1; j++)
                {
                    ptdist = ptdist+ae_sqr(kdt->xy.ptr.pp_float[i][j]-kdt->x.ptr.p_float[j], _state);
                }
            }
             ...
             */
            if( ae_fp_eq(ptdist,(float)(0))&&!kdt->selfmatch )
            {
                continue;
            }
             ...
             */
            if( ae_fp_eq(kdt->rneeded,(float)(0))||ae_fp_less_eq(ptdist,kdt->rneeded) )
            {
                ...
                else
                {
                     ...
                     */
                    if( ae_fp_less(ptdist,kdt->r.ptr.p_float[0]) )
                    {
                        if( kdt->kneeded==1 )
                        {
                            kdt->idx.ptr.p_int[0] = i;
                            kdt->r.ptr.p_float[0] = ptdist;
                        }
                        else
                        {
    ...
    if( kdt->nodes.ptr.p_int[offs]==0 )
    {
        ...
        s = kdt->splits.ptr.p_float[kdt->nodes.ptr.p_int[offs+2]];
         ...
         */
        if( ae_fp_less_eq(kdt->x.ptr.p_float[d],s) )
        {
        ...
        for(i=0; i<=1; i++)
        {
            ...
            if( updatemin )
            {
                ...
                if( ae_fp_less_eq(t1,s) )
                {
                    ...
                    if( kdt->normtype==1 )
                    {
                        kdt->curdist = kdt->curdist-ae_maxreal(v-t1, (float)(0), _state)+s-t1;
                    }
                    if( kdt->normtype==2 )
                    {
                        kdt->curdist = kdt->curdist-ae_sqr(ae_maxreal(v-t1, (float)(0), _state), _state)+ae_sqr(s-t1, _state);
                    }
                }
                kdt->curboxmin.ptr.p_float[d] = s;
            }
            else
            {
                ...
                if( ae_fp_greater_eq(t1,s) )
                {
                    ...
                    if( kdt->normtype==1 )
                    {
                        kdt->curdist = kdt->curdist-ae_maxreal(t1-v, (float)(0), _state)+t1-s;
                    }
                    if( kdt->normtype==2 )
                    {
                        kdt->curdist = kdt->curdist-ae_sqr(ae_maxreal(t1-v, (float)(0), _state), _state)+ae_sqr(t1-s, _state);
                    }
                }
                kdt->curboxmax.ptr.p_float[d] = s;
            }
             ...
             */
            if( ae_fp_neq(kdt->rneeded,(float)(0))&&ae_fp_greater(kdt->curdist,kdt->rneeded) )
            {
                todive = ae_false;
            }
            else
            {
                ...
                else
                {
                     ...
                     */
                    todive = ae_fp_less_eq(kdt->curdist,kdt->r.ptr.p_float[0]*kdt->approxf);
                }
            }
            if( todive )
            {
     ...
     ae_state *_state)
{
    ...
    if( kdt->normtype==0 )
    {
        ...
        {
            vx = x->ptr.p_float[i];
            vmin = kdt->boxmin.ptr.p_float[i];
            vmax = kdt->boxmax.ptr.p_float[i];
            kdt->x.ptr.p_float[i] = vx;
            kdt->curboxmin.ptr.p_float[i] = vmin;
            kdt->curboxmax.ptr.p_float[i] = vmax;
...
void xdebuginitrecord1(xdebugrecord1* rec1, ae_state *_state)
{
    ...
    rec1->a.ptr.p_float[0] = (float)(2);
    rec1->a.ptr.p_float[1] = (float)(3);
}
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugr1sum(/* Real    */ ae_vector* a, ae_state *_state)
{
    ae_int_t i;
    float result;
...
void xdebugr1neg(/* Real    */ ae_vector* a, ae_state *_state)
{
    ...
    for(i=0; i<=a->cnt-1; i++)
    {
        a->ptr.p_float[i] = -a->ptr.p_float[i];
    }
}
...
void xdebugr1appendcopy(/* Real    */ ae_vector* a, ae_state *_state)
{
    ...
    for(i=0; i<=b.cnt-1; i++)
    {
        b.ptr.p_float[i] = a->ptr.p_float[i];
    }
    ae_vector_set_length(a, 2*b.cnt, _state);
    for(i=0; i<=a->cnt-1; i++)
    {
        a->ptr.p_float[i] = b.ptr.p_float[i%b.cnt];
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_bool[i][j] = ae_fp_greater(ae_sin((float)(3*i+5*j), _state),(float)(0));
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_int[i][j] = ae_sign(ae_sin((float)(3*i+5*j), _state), _state);
        }
    }
}
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugr2sum(/* Real    */ ae_matrix* a, ae_state *_state)
{
    ae_int_t i;
    ae_int_t j;
    float result;
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            result = result+a->ptr.pp_float[i][j];
        }
    }
    return result;
}
...
void xdebugr2neg(/* Real    */ ae_matrix* a, ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_float[i][j] = -a->ptr.pp_float[i][j];
        }
    }
}
...
void xdebugr2transpose(/* Real    */ ae_matrix* a, ae_state *_state)
{
    ...
    for(i=0; i<=b.rows-1; i++)
    {
        for(j=0; j<=b.cols-1; j++)
        {
            b.ptr.pp_float[i][j] = a->ptr.pp_float[i][j];
        }
    }
    ae_matrix_set_length(a, b.cols, b.rows, _state);
    for(i=0; i<=b.rows-1; i++)
    {
        for(j=0; j<=b.cols-1; j++)
        {
            a->ptr.pp_float[j][i] = b.ptr.pp_float[i][j];
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_float[i][j] = ae_sin((float)(3*i+5*j), _state);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=a->rows-1; i++)
    {
        for(j=0; j<=a->cols-1; j++)
        {
            a->ptr.pp_complex[i][j].x = ae_sin((float)(3*i+5*j), _state);
            a->ptr.pp_complex[i][j].y = ae_cos((float)(3*i+5*j), _state);
        }
    }
}
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
float xdebugmaskedbiasedproductsum(ae_int_t m,
     ae_int_t n,
     /* Real    */ ae_matrix* a,
     /* Real    */ ae_matrix* b,
     /* Boolean */ ae_matrix* c,
     ae_state *_state)
{
    ...
    for(i=0; i<=m-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ...
            {
                result = result+a->ptr.pp_float[i][j]*(1+b->ptr.pp_float[i][j]);
            }
        }
    }
    return result;
